...
public class EdgeDetect : MonoBehaviour {
    ...
    void LateUpdate() {
        ...
        if (cam == null && width != -1) {
            ...
            edgeDetectMat.SetVector("_SensitivityAndWidthArgs", new UnityEngine.Vector4(depthSensitivity, normalsSensitivity, 0, 0));
        ...
        if (cam != null) {
            ...
            if (prevNormalsSensitivity != normalsSensitivity || prevDepthSensitivity != depthSensitivity || prevDepth2Sensitivity != depthSensitivity2) {
                edgeDetectMat.SetVector("_SensitivityAndWidthArgs", new UnityEngine.Vector4(normalsSensitivity, depthSensitivity, depthSensitivity2, 0));
                prevNormalsSensitivity = normalsSensitivity;
                prevDepthSensitivity = depthSensitivity;
